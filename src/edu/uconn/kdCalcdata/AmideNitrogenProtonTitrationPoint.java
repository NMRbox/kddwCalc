...
public class AmideNitrogenProtonTitrationPoint extends TitrationPoint
{
    ...
    public AmideNitrogenProtonTitrationPoint validateAndCreate(double ligandConc, double receptorConc,
        Resonance resonance1, Resonance resonance2)
    {
        // if its not a amide proton like its supposed to be, throw exception
        if (!(resonance1 instanceof AmideProton))
        ...
        if(!(resonance2 instanceof AmideNitrogen))
        ...
        if (!(TitrationPoint.isValid(ligandConc, receptorConc, resonance1, resonance2)))
